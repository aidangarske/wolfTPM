...
/* The FIFO/response buffer must hold a full command and response; a smaller
 * FWTPM_TIS_FIFO_SIZE override would let FWTPM_ProcessCommand overflow it. */
typedef char fwtpm_tis_fifo_size_check_[
